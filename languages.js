...
Object.assign(translations['zh-Hant'], {ministryShortcut:'選擇你的堂會',communityEyebrow:'一起生活',communityTitle:'社區事工與活動',communityIntro:'不止於主日。一起連繫、學習和成長。',communityAll:'查看所有活動',backHome:'返回歡迎頁面',filterAll:'所有活動',filterEvents:'即將舉行',filterProgrammes:'恆常活動',updatesTitle:'最新消息',updatesIntro:'與你的堂會保持聯繫。',updatesAll:'查看堂會所有消息',expect:'新來賓資料'});
Object.assign(translations['zh-Hans'], {ministryShortcut:'选择你的堂会',communityEyebrow:'一起生活',communityTitle:'社区事工与活动',communityIntro:'不止于主日。一起联系、学习和成长。',communityAll:'查看所有活动',backHome:'返回欢迎页面',filterAll:'所有活动',filterEvents:'即将举行',filterProgrammes:'常规活动',updatesTitle:'最新消息',updatesIntro:'与你的堂会保持联系。',updatesAll:'查看堂会所有消息',expect:'新来宾资料'});
